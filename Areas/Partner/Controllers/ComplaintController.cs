...
namespace Semester03.Areas.Partner.Controllers
{
    ...
    public class ComplaintController : Controller
    {
        ...
        public ComplaintController(ComplaintRepository complaintRepo, EventRepository eventRepository, TenantRepository tenantRepository)
        {
        ...
        public async Task<IActionResult> GetComplaintByTenantId(int id, int page = 1)
        {
            const int pageSize = 10;

            var list = await _complaintRepo.GetAllComplaintsByTenant(id);
        ...
        public async Task<ActionResult> DetailByTenant(int id)
        {
            var itemComplaint = await _complaintRepo.FindById(id);
            ViewBag.itemComplaint = itemComplaint;
            return View();
